    ...
    <footer class="border-t border-line py-10">
      <div class="mx-auto max-w-6xl px-6">
        ...
        <div class="mt-6 flex flex-wrap items-center gap-3 border-t border-line pt-6 text-xs text-ink-muted">
          ...
          <Link href="/privacy" class="font-semibold text-ink-2 hover:text-ink">Privacy</Link>
          <Link href="/terms" class="font-semibold text-ink-2 hover:text-ink">Terms</Link>
          <Link href="/guidelines" class="font-semibold text-ink-2 hover:text-ink">Community Guidelines</Link>
